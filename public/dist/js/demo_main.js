...
(function ($) {
  ...
  var $dark_mode_checkbox = $('<input />', {
    ...
    if ($(this).is(':checked')) {
        ...
        localStorage.setItem('theme','dark-mode text-light')
    } else {
  ...
  var $navbar_variants_colors = createSkinBlock(navbar_all_colors, function () {
    ...
    if (navbar_dark_skins.indexOf(color) > -1) {
      ...
      $(this).addClass(color).addClass('text-light')
        localStorage.setItem('navbar_dark_skins',color)
        localStorage.setItem('navbar_index',navbar_dark_skins.indexOf(color))
    } else {
    ...
    if (localStorage.getItem('navbar_dark_skins')){
        ...
        if (localStorage.getItem('navbar_index') > -1) {
            $main_header.addClass('navbar-dark')
            $(this).addClass(localStorage.getItem('navbar_dark_skins')).addClass('text-light')
        } else {
            $main_header.addClass('navbar-light')
            // $(this).addClass(localStorage.getItem('navbar_dark_skins'))
        }
        $main_header.addClass(localStorage.getItem('navbar_dark_skins'))
